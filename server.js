...
app.get('/api/books', routes.api_books) //get books
app.get('/api/song/*', routes.api_songDetails) //get song details
app.get('/api/book/*', routes.api_bookDetails) //get book details
app.post('/api/song/*', routes.api_update_song) //update data for a song
app.post('/api/book/*', routes.api_update_book) //update data for a book
...
app.listen(PORT, function(err){
  if (err) console.log(err)
    ...
    console.log(`Testing:`)
    console.log(`hardcoded user: ryan, password: lubin`)
